...
class Action {
    ...
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let context = docker.createBuildContext(registry, settings.dockerImageName, settings.dockerTags, settings.dockerSeedTags, settings.workingPath, settings.dockerFile);
            let images = yield docker.build(context, []);
